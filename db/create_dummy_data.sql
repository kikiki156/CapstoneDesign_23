...
INSERT INTO edulog."user"(user_name, user_email, user_password, role_id, school_id)
...
(SELECT user_id FROM edulog."user" WHERE user_email = 'teacher'));
...
(SELECT user_id FROM edulog."user" WHERE user_email = 'teacher2'));

INSERT INTO edulog.user_subject(user_id, subject_id, user_subject_hour)
VALUES ((SELECT user_id FROM edulog."user" WHERE user_email = 'teacher'),
(SELECT subject_id FROM edulog.subject WHERE subject_name = '국어'),
        1);
